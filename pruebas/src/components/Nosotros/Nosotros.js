...
<main className="max-w-6xl mx-auto py-10">
  ...
  <div className="grid-cols-3">
    <div className="persona-card">
      <img src="../public/Imagenes/cesar.jpeg" alt="Cesar Andrés Ortega Herrera" className="persona-img" />
    ...
    <div className="persona-card">
      <img src="../public/Imagenes/dieter.jpeg" alt="Al Dieter Valderrabano Garcia" className="persona-img" />
    ...
    <div className="persona-card">
      <img src="../public/Imagenes/Rodrigo.jpg" alt="Rodrigo Efren Tellez Guerrero" className="persona-img" />
    ...
    <div className="persona-card">
      <img src="../public/Imagenes/Julian.png" alt="M. I. Julián Garibaldi" className="persona-img" />
